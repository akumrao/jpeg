...
int main(int argc, char **argv)
{
	...
	sprintf(output, "%s", "testodd_gen.jpg");
    ...
    sprintf(input, "%s", argv[1]);
    sprintf(output, "%s", "testodd2x2_gen.jpg");
    sprintf(test, "%s", "testodd2x2.jpg");
    ...
    sprintf(input, "%s", "test1.bmp");
    sprintf(output, "%s", "test1_2x2_gen.jpg");
    sprintf(test, "%s", "test1_2x2.jpg");
    ...
    sprintf(input, "%s", "test1.bmp");
    sprintf(output, "%s", "test1_1x1_gen.jpg");
    sprintf(test, "%s", "test1_1x1.jpg");
